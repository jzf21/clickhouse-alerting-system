...
var AllRuleTemplates = []RuleTemplate{
	...
	{
		ID:           "http-connections",
		Name:         "Concurrent HTTP connections",
		Category:     "Resources",
		Description:  "Alert when concurrent HTTP connections exceed limit",
		Query:        "SELECT value AS cnt FROM system.metrics WHERE metric = 'HTTPConnection'",
		Column:       "cnt",
		Operator:     "gt",
		Threshold:    40,
		EvalInterval: 60,
